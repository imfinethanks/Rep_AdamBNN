...
class BasicBlock(nn.Module):
    def __init__(self, inplanes, planes, stride=1):
        ...
        self.binary_3x3= conv3x3(inplanes*2, int(inplanes/2), stride=stride)
        ...
        if inplanes == planes:
            self.binary_pw = conv1x1(inplanes*2, int(planes/2))
            self.bn2 = norm_layer(int(planes*2))
        else:
            self.binary_pw_down1 = conv1x1(inplanes*2, int(inplanes/2))
            self.binary_pw_down2 = conv1x1(inplanes*2, int(inplanes/2))
