...
# wandb.init(project="react_a_imagenet", entity="llll",name=time.strftime('%Y_%m_%d_%H:%M:%S'),group="react_a_imagenet_x2_step_2")
wandb.init(project="react_a_imagenet", entity="llll",name='2022_02_03_21:52:09',group="react_a_imagenet_x2_step_2",id='pxfm4vlu',resume='must')
